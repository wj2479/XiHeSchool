 ...
 * 带圆形图片 + 文字的 适配器
 */
public class CircleImageTextAdapter extends BaseAdapter {

    Context mContext;
    List<ImageText> imageTextList;

    public CircleImageTextAdapter(Context mContext, List<ImageText> imageTextList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.gridview_circle_item, null);
